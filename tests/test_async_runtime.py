    ...
    def test_sync_context_all_methods(self):
        ...
        for method_func, url in methods_and_urls:
            with self.subTest(method=method_func.__name__, url=url):
                ...
                # Should be a Response object
                self.assertTrue(hasattr(response, 'status_code'))
                self.assertIn(response.status_code, [200, 204])  # Some methods return 204
...
def run_async_tests():
    ...
    async def run_all_async_tests():
        ...
        async_tests = [
            ("test_async_context_detection", context_test.test_async_context_detection()),
            ("test_async_context_all_methods", context_test.test_async_context_all_methods()),
            ("test_async_generic_request_method", context_test.test_async_generic_request_method()),
            ("test_async_execution_performance", runtime_test.test_async_execution_performance()),
            ("test_event_loop_async_execution", event_loop_test.test_event_loop_async_execution()),
            ("test_concurrent_requests_in_async_context", event_loop_test.test_concurrent_requests_in_async_context()),
            ("test_async_runtime_resource_cleanup", behavior_test.test_async_runtime_resource_cleanup()),
            ("test_error_handling_in_async_context", behavior_test.test_error_handling_in_async_context()),
            ("test_timeout_handling_async", behavior_test.test_timeout_handling_async()),
        ]
