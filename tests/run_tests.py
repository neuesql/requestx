...
class TestRunner:
    ...
    def run_all_tests(self):
        ...
        success &= self.run_test_module('test_comprehensive', 'Comprehensive HTTP Tests')
        
        # Stage 3: Requests Compatibility Tests
        success &= self.run_test_module('test_requests_compatibility', 'Requests Compatibility Tests')
