use hyper::{Client, Method, Request, Uri, HeaderMap, Body};
...
impl RequestxClient {
    ...
    pub async fn put_async(&self, url: Uri, config: Option<RequestConfig>) -> Result<ResponseData, RequestxError> {
        let mut request_config = config.unwrap_or_else(|| RequestConfig {
            method: Method::PUT,
            url: url.clone(),
            headers: None,
    ...
    pub async fn delete_async(&self, url: Uri, config: Option<RequestConfig>) -> Result<ResponseData, RequestxError> {
        let mut request_config = config.unwrap_or_else(|| RequestConfig {
    ...
    pub async fn head_async(&self, url: Uri, config: Option<RequestConfig>) -> Result<ResponseData, RequestxError> {
        let mut request_config = config.unwrap_or_else(|| RequestConfig {
            method: Method::HEAD,
            url: url.clone(),
            headers: None,
    ...
    pub async fn options_async(&self, url: Uri, config: Option<RequestConfig>) -> Result<ResponseData, RequestxError> {
        let mut request_config = config.unwrap_or_else(|| RequestConfig {
    ...
    pub async fn patch_async(&self, url: Uri, config: Option<RequestConfig>) -> Result<ResponseData, RequestxError> {
        let mut request_config = config.unwrap_or_else(|| RequestConfig {
            method: Method::PATCH,
            url: url.clone(),
            headers: None,
    ...
    pub fn request_sync(&self, config: RequestConfig) -> Result<ResponseData, RequestxError> {
        if let Some(ref runtime) = self.runtime {
            ...
            let rt = Runtime::new()
                .map_err(|e| RequestxError::RuntimeError(format!("Failed to create runtime: {}", e)))?;
