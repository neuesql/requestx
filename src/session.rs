...
impl Session {
    ...
    fn new() -> PyResult<Self> {
        ...
        let client = RequestxClient::with_custom_client(hyper_client)
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(
                format!("Failed to create session client: {}", e)
            ))?;
    ...
    fn request(&self, py: Python, method: String, url: String, kwargs: Option<&PyDict>) -> PyResult<PyObject> {
    ...
    fn update_header(&self, name: String, value: String) -> PyResult<()> {
        ...
        let header_name = name.parse::<hyper::header::HeaderName>()
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(
                format!("Invalid header name '{}': {}", name, e)
            ))?;
        
        let header_value = value.parse::<hyper::header::HeaderValue>()
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyValueError, _>(
    ...
    fn __repr__(&self) -> String {
        ...
        format!("<Session headers={} cookies={}>", headers_count, cookies_count)
    }
}
